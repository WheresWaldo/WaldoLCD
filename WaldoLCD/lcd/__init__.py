...
# @Last Modified by:   BH
# @Last Modified time: 2018-10-15 13:51:19
...
def start():
    ...
    from WaldoLCD.lcd.EEPROM.EEPROM import EEPROM
    ...
    class WaldoScreenManager(ScreenManager):
        ...
        def __init__(self, **kwargs):
            ...
            self.acceptable_screens = {
                ...
                'TOOL1' :{'name': 'TOOL1', 
                         'title': waldoprinter.lang.pack['Utilities']['Tool1'] if self.more_than_one_extruder() else waldoprinter.lang.pack['Utilities']['Tool'], 
                         'back_destination':'extruder_control_screen', 
                         'function': self.generate_temperature_controls },
        ...
        def get_state(self):
            settings = waldoprinter.printer_instance._settings
        ...
        def generate_qr_screen(self, **kwargs):
            ...
            #
            access_control = waldoprinter.printer_instance._settings.global_get(['accessControl'])
        ...
        def generate_toolhead_select_screen(self, **kwargs):
            ...
            if self.tool_0 :
                ...
                if self.tool_0 and not self.tool_1:
                    t0.original_icon_name = waldoprinter.lang.pack['WaldoIcons']['Tool']
                    t0.icon_name = waldoprinter.lang.pack['WaldoIcons']['Tool']
        ...
        def cooldown_button(self, **kwargs):
            ...
            waldoprinter.printer_instance._printer.commands('M104 T0 S0')
            if extruder_count > 1:
                waldoprinter.printer_instance._printer.commands('M104 T1 S0')
    ...
    WaldoLCD.run()
    # except Exception as e:
    #   waldoprinter.printer_instance.restart_screen()
