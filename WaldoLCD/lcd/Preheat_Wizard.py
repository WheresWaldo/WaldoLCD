...
class Preheat_Overseer(object):
    ...
    def edit(self, option):
        ...
        content = Option_View(option=option,callback = self.switch_to_preheat, delete_callback = self.show_preheat_selection_screen, back_destination = waldoprinter.waldosm.current)
        waldoprinter.waldosm._generate_backbutton_screen(name='edit_preheat', title = lang.pack['Preheat']['Edit_Preset']['Title'] , back_destination=waldoprinter.waldosm.current, content=content)
    ...
    def create_preset(self):
        ...
        waldoprinter.waldosm._generate_backbutton_screen(name='edit_preheat', title = lang.pack['Preheat']['Edit_Preset']['Add_Material'] , back_destination=waldoprinter.waldosm.current, content=content)
...
class Option_View(BoxLayout):
    ...
    def get_keyboard_results(self, result):
        ...
        if result in preheat_settings or result == lang.pack['Preheat']['Edit_Preset']['Name_Default']:
            ...
            #make screen
            waldoprinter.waldosm._generate_backbutton_screen(name='duplicate_error', title = lang.pack['Preheat']['Duplicate']['Title'], back_destination='edit_preheat', content=modal_screen)
        else:
            overwrite()
    ...
    def delete_preset(self):
        ...
        #make screen
        waldoprinter.waldosm._generate_backbutton_screen(name='delete_preset', title = lang.pack['Preheat']['Delete']['Title'] , back_destination=screen, content=modal_screen)
