...
class Temperature_Operator(Button):
    ...
    def monitor_selected_temp(self, dt):
        ...
        if waldoprinter.waldosm.current != 'motor_control_screen' and waldoprinter.waldosm.current != 'tool0' and waldoprinter.waldosm.current != 'tool1':
            return False
...
class Extruder_Movement(MotorControl):
    def __init__(self, move, toggle_mm):
        ...
        temp_controls = Temperature_Operator(waldoprinter.waldosm.generate_temperature_controls, 'tool0', 'Icons/blue_button_style.png')
...
class Mover():
    ...
    def home(self, value):
        waldoprinter.printer_instance._printer.home(['x', 'y', 'z'])

    def raise_buildplate(self, value):
        waldoprinter.printer_instance._printer.commands('G28')
        waldoprinter.printer_instance._printer.commands('G90')
        waldoprinter.printer_instance._printer.commands('G1 Z20 F3000')
