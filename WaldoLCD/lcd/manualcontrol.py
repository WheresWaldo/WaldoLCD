...
class TemperatureControl(BoxLayout):
    ...
    def update(self, dt):
        if self.desired_temp == 0:
            self.ids.set_cool.text = waldoprinter.lang.pack['Temperature_Controls']['Cooldown']
            self.ids.set_cool.background_normal = 'Icons/blue_button_style.png'
        else:
            self.ids.set_cool.text = waldoprinter.lang.pack['Temperature_Controls']['Set']
    ...
    def set_temperature(self, ext):
        ...
        waldoprinter.printer_instance._printer.set_temperature(ext, temp )
