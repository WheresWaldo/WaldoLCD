...
class PConsole(octoprint.printer.PrinterCallback):
    ...
    def find_M201(self, data):
        ...
        if ma != []:
            #waldoprinter.printer_instance._logger.info("M201 "+ str(self.counter))
    ...
    def find_M200(self, data):
        #waldoprinter.printer_instance._logger.info("M200 "+ str(self.counter))
        p = "D([-0-9.00]+)"
        ...
        finished_time = (time.time() - self.cur_time) * 1000
        waldoprinter.printer_instance._logger.info("M200 getting it in " + str(finished_time) + " ms")
    ...
    def find_M851(self, data):
        ...
        waldoprinter.printer_instance._logger.info(str(self.eeprom))

            #waldoprinter.printer_instance._logger.info("M851 "+ str(self.counter))
    ...
    def find_zoffset(self,data):
        ...
        if zo != []:
            #waldoprinter.printer_instance._logger.info('Zoffset Background Update ' + str(zo[0]))
