...
# @Last Modified by:   BH
# @Last Modified time: 2018-10-15 17:33:53
...
#body_text,image_source, button_function, button_text = waldoprinter.lang.pack['Button_Screen']['Default_Button']

#Title_Button_Screen
#title_text, body_text, button_function, button_text = waldoprinter.lang.pack['Button_Screen']['Default_Button']
...
class Button_Screen(BoxLayout, Wizard_Screen_Controls):
    ...
    def __init__(self, body_text, button_function, button_text = waldoprinter.lang.pack['Button_Screen']['Default_Button'], **kwargs):
...
class Object_Button_Screen(BoxLayout, Wizard_Screen_Controls):
    ...
    def __init__(self, custom_object, button_function, button_text = waldoprinter.lang.pack['Button_Screen']['Default_Button'], **kwargs):
...
class Image_on_Button_Screen(BoxLayout, Wizard_Screen_Controls):
    ...
    def __init__(self, body_text, button_function, button_image, button_text = waldoprinter.lang.pack['Button_Screen']['Default_Button'], **kwargs):
...
class Picture_Button_Screen(BoxLayout, Wizard_Screen_Controls):
    ...
    def __init__(self, title_text, body_text,image_source, button_function, button_text = waldoprinter.lang.pack['Button_Screen']['Default_Button'], **kwargs):
...
class Title_Picture_Image_on_Button_Screen(BoxLayout, Wizard_Screen_Controls):
    ...
    def __init__(self, title_text, body_text,image_source, button_function, button_image, button_text = waldoprinter.lang.pack['Button_Screen']['Default_Button'], **kwargs):
...
class Picture_Image_on_Button_Screen(BoxLayout, Wizard_Screen_Controls):
    ...
    def __init__(self, body_text,image_source, button_function, button_image, button_text = waldoprinter.lang.pack['Button_Screen']['Default_Button'], **kwargs):
...
class Picture_Button_Screen_Body(BoxLayout, Wizard_Screen_Controls):
    ...
    def __init__(self, body_text,image_source, button_function, button_text = waldoprinter.lang.pack['Button_Screen']['Default_Button'], **kwargs):
...
class Title_Button_Screen(BoxLayout, Wizard_Screen_Controls):
    ...
    def __init__(self, title_text, body_text, button_function, button_text = waldoprinter.lang.pack['Button_Screen']['Default_Button'], **kwargs):
...
class KeyboardInput(FloatLayout, Wizard_Screen_Controls):
    ...
    def __init__(self, keyboard_callback = None,
        ...
        if self.back_destination == None:
            self.back_destination = waldoprinter.waldo_screen()
        ...
        if self.bb == None:
            ...
            self.bb.make_screen(self,
                             ...
                             group=self.group)
        self.current_screen = waldoprinter.waldo_screen()
        self._keyboard = None
    ...
    def monitor_screen_change(self,dt):
        ...
        if self.bb == None:
            if self.current_screen != waldoprinter.waldo_screen():
                if self._keyboard:
                    Window.release_all_keyboards()
...
class Extruder_Selector(Override_Layout, Wizard_Screen_Controls):
    ...
    def show_screen(self):
        ...
        if self.make_screen == None:
            waldoprinter.back_screen(name = 'select_extruder',
                                    title = title,
