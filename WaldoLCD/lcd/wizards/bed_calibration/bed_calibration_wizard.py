...
# @Last Modified by:   BH
# @Last Modified time: 2018-10-15 14:55:31
#kivy
...
from WaldoLCD.lcd.wizards.bed_calibration.bedcal_workflow import BedCal_Workflow
...
class Bed_Calibration(object):
    ...
    def welcome_screen(self):
        self.welcome = Button_Screen(waldoprinter.lang.pack['Bed_Cal_Wizard']['Welcome']['Body'],
    ...
    def finish_bed_cal_wizard(self):
        ...
        self.finish_wizard = Picture_Button_Screen(waldoprinter.lang.pack['Bed_Cal_Wizard']['Finish_Wizard']['Sub_Title'],
