...
# @Last Modified by:   BH
# @Last Modified time: 2018-10-15 14:54:53
...
from WaldoLCD.lcd.common_screens import Object_Modal_Question, Object_Button_Screen, Modal_Question_No_Title, Button_Screen, Image_on_Button_Screen, Picture_Image_on_Button_Screen, Temperature_Wait_Screen, Title_Picture_Image_on_Button_Screen, Heater_Selector
from WaldoLCD.lcd.Language import lang
from PID_Screens import PID_Test_Screen, PID_Finish_Object
from WaldoLCD.lcd.connection_popup import Info_Popup
...
class PID_Overseer(object):
    ...
    def start_workflow(self):
        ...
        #start the test
        waldoprinter.printer_instance._printer.commands(command)
    ...
    def save_PID(self, PID):
        ...
        #save PID
        waldoprinter.printer_instance._printer.commands(pid_command)
        waldoprinter.printer_instance._printer.commands("M500") #save
