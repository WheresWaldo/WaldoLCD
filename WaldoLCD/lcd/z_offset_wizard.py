...
class ZoffsetWizard(object):
    def __init__(self, waldosm, back_destination, **kwargs):
    ...
    def first_screen(self, **kwargs):
        ...
        self.sm._generate_backbutton_screen(name=self.name, title=waldoprinter.lang.pack['ZOffset_Wizard']['Welcome'] , back_destination=kwargs['back_destination'], content=c)
...
class Z_Offset_Adjuster(BoxLayout):
    ...
    s_toggle_mm = [waldoprinter.lang.pack['ZOffset_Wizard']['zero_five'],waldoprinter.lang.pack['ZOffset_Wizard']['one_zero'], waldoprinter.lang.pack['ZOffset_Wizard']['two_zero']]
