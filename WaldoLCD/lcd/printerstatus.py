...
class PrinterStatusContent(BoxLayout):
    ...
    def detirmine_layout(self):
        ...
        if tool0 and tool1 and bed:
            ...
            tool_1 = Tool_Status(waldoprinter.lang.pack['Tool_Status']['Tool2'], "tool1")
    ...
    def check_updates(self):
        ...
        if installed < available and available != waldoprinter.lang.pack['Update_Printer']['Connection_Error'] and not self.update_lock:
    ...
    def update(self, dt):
        ...
        if print_time_left != None:
            ...
            if int(time_remaining['hours']) == 0 and int(time_remaining['minutes']) == 0:
                self.etr = waldoprinter.lang.pack['Printer_Status']['Minute_Left']
            else:
        ...
        if progress == 100:
            waldoprinter.printer_instance._printer.unselect_file()  
            return False
...
class StartPauseButton(Auto_Image_Label_Button):
    def __init__(self, **kwargs):
        ...
        self.button_text = '[size=30]' + waldoprinter.lang.pack['File_Screen']['Pause'] + '[/size]'
    ...
    def toggle_pause_print(self):
        waldoprinter.printer_instance._printer.toggle_pause_print()
    ...
    def sync_with_devices(self, dt):
        ...
        if is_paused and self.button_text ==  '[size=30]{}[/size]'.format(waldoprinter.lang.pack['File_Screen']['Pause']):
            self.button_text =  '[size=30]{}[/size]'.format(waldoprinter.lang.pack['File_Screen']['Resume'])
            self.image_icon = 'Icons/Manual_Control/start_button_icon.png'
        elif not is_paused and self.button_text ==  '[size=30]{}[/size]'.format(waldoprinter.lang.pack['File_Screen']['Resume']):
            self.button_text =  '[size=30]{}[/size]'.format(waldoprinter.lang.pack['File_Screen']['Pause'])
            self.image_icon = "Icons/Printer Status/pause_button_icon.png"
            self.auto_pause_pop = None
...
class CancelButton(Auto_Image_Label_Button):
    ...
    def __init__(self):
        ...
        self.button_text = '[size=30]' + waldoprinter.lang.pack['File_Screen']['Cancel'] + '[/size]'
    ...
    def cancel_callback(self, dt):
        if self.is_printing() or waldoprinter.printer_instance._printer.is_paused() == True:
            waldoprinter.printer_instance._printer.cancel_print()
...
class ModalPopup(ModalView):
    ...
    def cancellation_feedback(self):
        self.ids.modal_question.text = waldoprinter.lang.pack['File_Screen']['Canceling']
    ...
    def populate_buttons(self):
        ...
        yes_button = Auto_Image_Label_Button('[size=30]' + waldoprinter.lang.pack['Popup']['PYes'], 'Icons/Manual_Control/ok_button_icon.png', 'Icons/blue_button_style.png', self.cancel_popup)
        no_button = Auto_Image_Label_Button('[size=30]' + waldoprinter.lang.pack['Popup']['PNo'], 'Icons/Manual_Control/cancel_button_icon.png', 'Icons/red_button_style.png', self.dismiss_pop)
