...
class Slicer_Wizard(FloatLayout):
    ...
    def show_confirmation_screen(self):
        ...
        title = waldoprinter.lang.pack['Slicer_Wizard']['Confirmation']['Title']
        back_destination = "File_Explorer"
        layout = STL_Confirmation_Screen(self.choose_overrides, self.file_data['name'])
        waldoprinter.back_screen(name = screen_name, 
                                title = title, 
    ...
    def choose_overrides(self):
        ...
        title = waldoprinter.lang.pack['Slicer_Wizard']['Overrides']['Title']
    ...
    def slice_stl(self, overrides):
        ...
        self.progress_pop =  USB_Progress_Popup(waldoprinter.lang.pack['Slicer_Wizard']['Progress']['Sub_Title'] + self.file_data['name'], 1)
        ...
        self.stl_path = waldoprinter.printer_instance._file_manager.path_on_disk('local', self.file_data['path'])
        self.overrides = overrides

        Clock.schedule_once(self.start_slice, 0.1)

    def start_slice(self,dt):
        profiles = waldoprinter.printer_instance._slicing_manager.all_profiles('cura', require_configured=False)
        if 'robo' in profiles:
            #start slice
            self.temp_path = TEMP_DIR + "/" + self.stl_name
            Logger.info("Starting Slice")
            Logger.info(self.overrides)
            waldoprinter.printer_instance._slicing_manager.slice('cura', 
                                                                self.stl_path, 
                                                                self.temp_path, 
                                                                'robo', 
                                                                self.sliced, 
            ...
            if os.path.isfile(profile_path):
                ...
                if dt < 5:
                    ...
                    ep = Error_Popup(waldoprinter.lang.pack['Slicer_Wizard']['Error']['Profile']['Sub_Title'], waldoprinter.lang.pack['Slicer_Wizard']['Error']['Profile']['Body'],callback=partial(waldoprinter.waldosm.go_back_to_main, tab='printer_status_tab'))
                    ep.show()
    ...
    def error_pop(self, dt, *args, **kwargs):
        ...
        ep = Error_Popup(waldoprinter.lang.pack['Slicer_Wizard']['Error']['Slice']['Sub_Title'], waldoprinter.lang.pack['Slicer_Wizard']['Error']['Slice']['Body'],callback=partial(waldoprinter.waldosm.go_back_to_main, tab='printer_status_tab'))
        ep.show()
...
class Override_Page(object):
    ...
    def set_support(self, **kwargs):
        ...
        none_button = OL_Button(waldoprinter.lang.pack['Slicer_Wizard']['Support']['No_Supports'],
                                "Icons/Slicer wizard icons/No Supports.png",
                                none,
                                enabled = True,
                                observer_group = sup_overseer)

        buildplate_button = OL_Button(waldoprinter.lang.pack['Slicer_Wizard']['Support']['Buildplate'],
                                "Icons/Slicer wizard icons/Supports buildplate.png",
                                buildplate,
                                enabled = False,
                                observer_group = sup_overseer)

        everywhere_button = OL_Button(waldoprinter.lang.pack['Slicer_Wizard']['Support']['Everywhere'],
        ...
        layout = Override_Layout(bl, waldoprinter.lang.pack['Slicer_Wizard']['Support']['Body'])
        back_destination = waldoprinter.waldosm.current
        waldoprinter.back_screen(name = 'support_page',
                                title = waldoprinter.lang.pack['Slicer_Wizard']['Support']['Title'],
                                back_destination=back_destination,
                                content=layout,
    ...
    def raft_option(self):
        ...
        none_button = OL_Button(waldoprinter.lang.pack['Slicer_Wizard']['Raft_Support']['no_raft'], 
                                "Icons/Slicer wizard icons/No Supports.png", 
                                none,
                                enabled = False,
                                observer_group = raft_bgo)
        raft_button = OL_Button(waldoprinter.lang.pack['Slicer_Wizard']['Raft_Support']['raft'], 
                                "Icons/Slicer wizard icons/rafts_1.png", 
                                raft,
                                enabled = True,
                                observer_group = raft_bgo)

        brim_button = OL_Button(waldoprinter.lang.pack['Slicer_Wizard']['Raft_Support']['brim'], 
        ...
        layout = Override_Layout(bl, waldoprinter.lang.pack['Slicer_Wizard']['Raft_Support']['Body'])
        back_destination = waldoprinter.waldosm.current
        waldoprinter.back_screen(name = 'raft and support', 
                                title = waldoprinter.lang.pack['Slicer_Wizard']['Raft_Support']['Title'] , 
                                back_destination=back_destination, 
                                content=layout,
    ...
    def print_quality(self):
        ...
        mm_20_button = OL_Button(waldoprinter.lang.pack['Slicer_Wizard']['Print_Quality']['mm_20'], 
                                "Icons/Slicer wizard icons/60px/step1 (1).png", 
                                mm_20, 
                                enabled = False, 
                                observer_group = bgo_pq)
        mm_15_button = OL_Button(waldoprinter.lang.pack['Slicer_Wizard']['Print_Quality']['mm_15'], 
                                "Icons/Slicer wizard icons/60px/step2 (1).png", 
                                mm_15, 
                                enabled = True, 
                                observer_group = bgo_pq)
        mm_10_button = OL_Button(waldoprinter.lang.pack['Slicer_Wizard']['Print_Quality']['mm_10'], 
                                "Icons/Slicer wizard icons/60px/step3 (1).png", 
                                mm_10, 
                                enabled = False, 
                                observer_group = bgo_pq)
        mm_06_button = OL_Button(waldoprinter.lang.pack['Slicer_Wizard']['Print_Quality']['mm_06'], 
        ...
        layout = Override_Layout(bl, waldoprinter.lang.pack['Slicer_Wizard']['Print_Quality']['Body'])
        back_destination = waldoprinter.waldosm.current
        waldoprinter.back_screen(name = 'print quality', 
                                title = waldoprinter.lang.pack['Slicer_Wizard']['Print_Quality']['Title'] , 
                                back_destination=back_destination, 
                                content=layout,
    ...
    def infill_layout(self):
        ...
        percent_0 = OL_Button(waldoprinter.lang.pack['Slicer_Wizard']['Infill']['p_0'], 
                              "Icons/Slicer wizard icons/hollow.png", 
                              p_0, 
                              enabled = False, 
                              observer_group = bgo_pq)
        percent_10 = OL_Button(waldoprinter.lang.pack['Slicer_Wizard']['Infill']['p_10'], 
                               "Icons/Slicer wizard icons/10%.png", 
                               p_10, 
                               enabled = True, 
                               observer_group = bgo_pq)
        percent_25 = OL_Button(waldoprinter.lang.pack['Slicer_Wizard']['Infill']['p_25'], 
                               "Icons/Slicer wizard icons/25%.png", 
                               p_25, 
                               enabled = False, 
                               observer_group = bgo_pq)
        percent_100 = OL_Button(waldoprinter.lang.pack['Slicer_Wizard']['Infill']['p_100'], 
        ...
        layout = Override_Layout(bl, waldoprinter.lang.pack['Slicer_Wizard']['Infill']['Body'])
        back_destination = waldoprinter.waldosm.current
        waldoprinter.back_screen(name = 'infill', 
                                title = waldoprinter.lang.pack['Slicer_Wizard']['Infill']['Title'], 
                                back_destination=back_destination, 
                                content=layout,
    ...
    def set_fans(self):
        ...
        on_button = OL_Button(waldoprinter.lang.pack['Slicer_Wizard']['Fans']['fan_on'],
                              "Icons/Slicer wizard icons/Fans on.png",
                              fans_on,
                              enabled = True,
                              observer_group = fan_overseer)

        off_button = OL_Button(waldoprinter.lang.pack['Slicer_Wizard']['Fans']['fan_off'],
        ...
        layout = Override_Layout(bl, waldoprinter.lang.pack['Slicer_Wizard']['Fans']['Body'])
        back_destination = waldoprinter.waldosm.current
        waldoprinter.back_screen(name = 'fans_page',
                                title = waldoprinter.lang.pack['Slicer_Wizard']['Fans']['Title'],
                                back_destination=back_destination,
                                content=layout,
